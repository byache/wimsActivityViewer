...
def data_factory(file,feuille,dirpath):  #file : le fichier .zip contenant l'archive de la classe wims ; feuille : un integer contenant le numéro de la feuille wims à regarder
    ...
    for i in range(len(data)):
        ...
        listscores=[[] for i in range(50)] #un élément par exo. Cet élément va contenir la liste des scores obtenus à cet exo, dans l'ordre
        ...
        user.note=computescore(listscores,prepare,sn,st)
